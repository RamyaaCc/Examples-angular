...
public class methodRef {
 ...
 public static void main(String[] args)
 {
     ...
     // using add() method
     personList.add(new Person("ramya", 22));
     personList.add(new Person("sri", 19));
     personList.add(new Person("mathi", 20));

     // Using static method reference to
     // sort array by name
     Collections.sort(personList, methodRef::compareByName);
